        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 18),
              const _RoundedField(hint: 'Your Name', icon: Icons.person_outline_rounded),
              const SizedBox(height: 14),
              const _RoundedField(hint: 'Email', icon: Icons.mail_outline_rounded),
              const SizedBox(height: 14),
              const _RoundedField(hint: 'New password', icon: Icons.lock_outline_rounded, obscureText: true),
              const SizedBox(height: 14),
              const _RoundedField(hint: 'Confirm password', icon: Icons.lock_outline_rounded, obscureText: true),
...
class _RoundedField extends StatelessWidget {
  const _RoundedField({required this.hint, required this.icon, this.obscureText = false});
